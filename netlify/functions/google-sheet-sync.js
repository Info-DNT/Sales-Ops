...
exports.handler = async function (event) {
    ...
    const appsScriptUrl = process.env.APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbxBTyKy6QlpO2Mc6xQLPUio0oF4pX-y3a7o94ncUqRzYoYuM8fpKrIPDA0EVC6hXlTN7Q/exec';
